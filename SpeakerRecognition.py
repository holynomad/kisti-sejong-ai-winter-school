import librosa
import numpy as np
from sklearn.mixture import GaussianMixture as GMMim
...
if __name__=="__main__":
    audio_path = "/Users/holynomad/Documents/2020 KISTI AI윈터스쿨/KISTI강의_실습용/" # 절대경로 이용
    ...
    # 3. GMM 모델 구축 및 학습
    # issues : sklearn new ver. deprecation 오류로 old ver.(0.15) 라이브러리 재설치 검토 : https://stackoverflow.com/questions/55799601/problem-with-gmm-library-from-sklear-mixture
